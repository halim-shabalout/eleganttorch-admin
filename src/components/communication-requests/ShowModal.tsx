...
export default function ShowModal({ isOpen, onClose, communication }: Props) {
      ...
      >
        ...
        <div className="space-y-4 max-h-[70vh] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-gray-400 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent">
          ...
          <InfoItem
            ...
            label={messages["communication_request_name"] || "Name"}
          ...
          <InfoItem
            ...
            label={messages["communication_request_phone"] || "Phone"}
          ...
          <InfoItem
            ...
            label={messages["communication_request_message"] || "Message"}
